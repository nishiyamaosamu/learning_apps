...
//
// 実行: cd apps/ipa_sg && mise exec -- flutter test test/page_fit_test.dart
import 'dart:convert';
import 'dart:io';
...
import 'package:ipa_sg/app_design.dart';
...
void main() {
  ...
  final colorScheme = ipaSgDesignScheme.toColorScheme();
